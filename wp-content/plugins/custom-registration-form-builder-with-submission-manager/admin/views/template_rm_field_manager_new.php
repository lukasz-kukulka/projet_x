        ...
        <div id="rm-form-page-id-1" class="rm-form-builder-box">
            ...
            <li class="rm-fields-row <?php echo 'rm-fields-' . str_replace(':', '-', $row->columns); ?>" id="<?php echo esc_attr($row->row_id); ?>">
                ...
                <div class="rm-field-row-actions">
                    ...
                    <div class="rm-field-row-duplicate rm-field-row-action" title="Duplicate Row"><a href="?page=rm_field_manage&rm_form_id=<?php echo esc_attr($data->form_id); ?>&rm_row_id=<?php echo esc_attr($row->row_id); ?>&rm_form_page_no=<?php echo esc_attr($row->page_no); ?>&rm_action=duplicate_row"><span class="material-icons">content_copy</span></a></div>
                </div>
                ...
                <div class="rm-form-field<?php echo ($row->columns == '2:1' && $field_order == 0) ? ' rm-2-col' : ' rm-1-col'; ?>" rm-grid-id="<?php echo esc_attr($field_order) + 1; ?>" id="rm-col-<?php echo esc_attr($field->field_id);?>">
                    <div class="rm-col-area" id="<?php echo esc_attr($field->field_id);?>">
                        ...
                        <div class="rm-field-actions" data-title="<?php echo $field->field_type; ?>">
                ...
                <?php } else { ?>
                <div class="rm-form-field<?php echo ($row->columns == '2:1' && $field_order == 0) ? ' rm-2-col' : ' rm-1-col'; ?>" id="rm-col-<?php echo esc_attr($row->row_id.'-'.$field_order);?>">
    ...
    jQuery(".rm-form-field").droppable({
        ...
        drop: function(event, ui) {
                ...
                pre_row_id = src.closest('li').attr("id");
                    jQuery("li#"+pre_row_id+".rm-fields-row .rm-form-field").each(function() {
                ...
                var colSequence = 0;
                var rowFieldId = [];
                    jQuery("li#"+rm_row_id+".rm-fields-row .rm-form-field").each(function() {
                        if(jQuery(this).find('.rm-insert-field-button a').length){
                            jQuery(this).find('.rm-insert-field-button a').attr('data-order', colSequence);
                            jQuery(this).find('.rm-insert-field-button a').attr('data-row-id', pre_row_id);
