...
class RM_Services {
    ...
    public static function import_form_first_ajax() {
        if(current_user_can('manage_options') && check_ajax_referer( 'rm_import_first', 'rm_ajaxnonce' ))
        {
            $form_id = null;
    ...
    public function get_all_form_rows($form_id) {
        if ((int) $form_id)
            return RM_DBManager::get_rows_by_form_id($form_id);
        else
            return false;
    }
    ...
    public function forms_template_lists($type=''){
        $template = array();
            ...
            //Premium
                ...
                $template[] = array('title'=>'Job Application Form','description'=>'Solicit applications for openings in your organization by collecting MS Word or PDF resume files, along with skills profile.','id'=>'cp2','type'=>'contact','ver'=>'premium','multipage'=> 1, 'create_user'=>0 );
