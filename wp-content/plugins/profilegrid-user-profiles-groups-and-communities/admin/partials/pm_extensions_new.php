    ...
    <div class="pg-ext-list-wrap"> 
        ...
        <div class="pg-ext-list" id="the-list">
         ...
         <?php foreach($extensions_list as $ext): 
             ...
             ?>
            <div class="pg-box-col-4 pg-card-mb-16 pg-ext-card pgfilterDiv <?php echo $ext["filter"]; ?>">
                <div class="pg-box-border pg-box-p-18 pg-box-white-bg pg-box-h-100">
                    ...
                    <div class="pg-ext-box-description">
                        ...
                        <p class="authors" style="display:none"> <cite><?php echo esc_html('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="https://profilegrid.co/extensions/"><?php esc_html_e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
