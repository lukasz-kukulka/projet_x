     ...
     <div class="pm-card pg-box-h-100 pg-card-mb-16">
      ...
      <div class="pg-box-card-setting-wrap">
        ...
        <div class="pg-box-card-setting-item">
            ...
            <a href="admin.php?page=pm_profile_fields&gid=<?php echo esc_attr($group->id);?>"><span class="material-icons">view_list</span></a></div>
      </div>
      </label>
     </div>
    ...
    <div class="pg-group-side-banner pg-card-mb-16 pg-box-border pg-box-white-bg">
        ...
        <div class="pg-box-row">
            <div class="pg-box-col-12 ">
                ...
                <div class="pg-box-title pg-sidebar-legend-title pg-card-mb-16"><?php esc_html_e('Legend', 'profilegrid-user-profiles-groups-and-communities'); ?></div>
                <ul class="pg-card-mb-16">
                    <li><span class="material-icons"> view_list </span>  <?php esc_html_e('Group Registration Form', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                    <li><span class="material-icons"> settings </span>  <?php esc_html_e('Group Options', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                    <li><span class="material-icons"> group </span>  <?php esc_html_e('Members List', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                    <li><span class="material-icons"> person_add </span>  <?php esc_html_e('Membership Requests', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                    <li><span class="material-icons"> add </span>  <?php esc_html_e('Create Group Page', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                    <li><span class="material-icons"> insert_drive_file </span>  <?php esc_html_e('Open Group Page', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                    <li><span class="material-icons pg-group-status-icon"> public </span> <?php esc_html_e('Open or Public Groups', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                    <li><span class="material-icons pg-group-status-icon"> locked </span> <?php esc_html_e('Closed or Private Groups', 'profilegrid-user-profiles-groups-and-communities'); ?></li>
                </ul>

                <div class="pg-legend-note"> <?php _e('<strong>Note:</strong> Click on any empty area inside a group card to select it. Select multiple groups to delete or duplicate them.', 'profilegrid-user-profiles-groups-and-communities'); ?></div>
            </div>
            ...
            <div class="pg-box-col-12">
                <div class="pg-side-banner-wrap">
                    <div class="pg-side-banner-content">
                        ...
                        <p> <?php esc_html_e('Recommended read for quick and easy setup', 'profilegrid-user-profiles-groups-and-communities'); ?></p>
