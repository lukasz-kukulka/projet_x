	...
	$exclude = array("_wpnonce","_wp_http_referer","submit_group","group_id","group_tab");
        if($groupid!=0)
        {
            if(isset($_POST['group_options']))
            {
                ...
                {
                    if(!isset($_POST['group_options']['show_admin_manager'])) $_POST['group_options']['show_admin_manager'] = 0;
                }
                
                if($group_tab=='emails')
                {
                    if(!isset($_POST['group_options']['enable_notification'])) $_POST['group_options']['enable_notification'] = 0;
                    if(!isset($_POST['group_options']['enable_group_admin_notification'])) $_POST['group_options']['enable_group_admin_notification'] = 0;
                }
                
                if($group_tab=='display_name_pattern')
                {
                    if(!isset($_POST['group_options']['display_name'])) $_POST['group_options']['display_name'] = 0;
                    if(!isset($_POST['group_options']['enable_prefix'])) $_POST['group_options']['enable_prefix'] = 0;
                    if(!isset($_POST['group_options']['enable_postfix'])) $_POST['group_options']['enable_postfix'] = 0;
                    
                }
                
                if($group_tab=='forums')
                {
                    if(!isset($_POST['group_options']['bbpress_enable_tab'])) $_POST['group_options']['bbpress_enable_tab'] = 0;
                    if(!isset($_POST['group_options']['bbpress_create_topics'])) $_POST['group_options']['bbpress_create_topics'] = 0;
                    if(!isset($_POST['group_options']['bbpress_create_replies'])) $_POST['group_options']['bbpress_create_replies'] = 0;
                    
                }
                
                if($group_tab=='mailchimp')
                {
                    if(!isset($_POST['group_options']['enable_mailchimp'])) $_POST['group_options']['enable_mailchimp'] = 0;
                    if(!isset($_POST['group_options']['enable_mailchimp_tab'])) $_POST['group_options']['enable_mailchimp_tab'] = 0;
                    
                }
                
                if($group_tab=='woocommerce')
                {
                    if(!isset($_POST['group_options']['woocommerce_vendor_dashboard_tab'])) $_POST['group_options']['woocommerce_vendor_dashboard_tab'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_shop_tab'])) $_POST['group_options']['woocommerce_shop_tab'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_shop_setting_tab'])) $_POST['group_options']['woocommerce_shop_setting_tab'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_purchases_tab'])) $_POST['group_options']['woocommerce_purchases_tab'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_reviews_tab'])) $_POST['group_options']['woocommerce_reviews_tab'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_orders_in_account'])) $_POST['group_options']['woocommerce_orders_in_account'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_shipping_address_in_account'])) $_POST['group_options']['woocommerce_shipping_address_in_account'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_billing_address_in_account'])) $_POST['group_options']['woocommerce_billing_address_in_account'] = 0;
                    if(!isset($_POST['group_options']['woocommerce_show_total_spent'])) $_POST['group_options']['woocommerce_show_total_spent'] = 0;
                    
                }
                
                if($group_tab=='group_fields')
                {
                    if(!isset($_POST['group_options']['group_fields_option'])) $_POST['group_options']['group_fields_option'] = 0;
                }
                
                $_POST['group_options'] = array_replace_recursive($group_options,$_POST['group_options']);
                
            }
            else
            {
                 $_POST['group_options'] = $group_options;
            }
        }
    ...
    <div class="pg-box-border pg-box-h-100 pg-box-white-bg pg-box-row">
        <div class="pg-box-col-3 pg-box-border-right">
            <div class="pg-group-setting-head">
                ...
                <!-- Group Name -->
             <div class="pg-group-name"><?php echo $row->group_name; ?></div>
                 <!-- Group Name -->
                 <?php if(strtolower($group_type)=='open'):?>
             <div class="pg-add-group-tabview pg-group-status-wrap pg-group-status-open">
            <span class="material-icons">public</span>
            <span><?php echo esc_html($group_type);?></span> <span class="pg-status-sep">&#8901;</span> <?php if($row->is_group_limit==1){ echo esc_html($total_users).'/'.esc_html($row->group_limit);} else{  echo esc_html($total_users);}?></div>
            <?php else: ?>
            ...
            <?php endif;?>
             ...
             $where = array('gid'=>$row->id,'status'=>'1');
             ...
             ?>
                 <div class="pg-group-requests"> <a href="admin.php?page=pm_requests_manager&pagenum=1&gid=<?php echo esc_attr($row->id); ?>" class="pg-d-flex pg-box-center"><span class="material-icons"> person_add </span> <?php echo sprintf(esc_html__('%d pending requests',''),$count);?></a></div>
             <?php endif;?>
            </div>
            ...
            <div class="pg-options-nav pg-core-options">
                <div class="pg-setting-title">Core Options</div>
                <ul>
                    <li class="<?php if($tab=="basics"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=basics"><?php _e('Basics', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="membership"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=membership"><?php _e('Membership', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="management"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=management"><?php _e('Management', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="emails"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=emails"><?php _e('Emails', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="group_registration_form"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=group_registration_form"><?php _e('Group Registration Form', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
            ...
            <div class="pg-options-nav pg-core-options">
                ...
                <ul>
                    <li class="<?php if($tab=="display_name_pattern"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=display_name_pattern"><?php _e('Display Name Pattern', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="forums"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=forums"><?php _e('Forums', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="mailchimp"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=mailchimp"><?php _e('Mailchimp', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="woocommerce"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=woocommerce"><?php _e('WooCommerce', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <li class="<?php if($tab=="group_fields"){echo 'pg-active-tab';} ?>"><a href="admin.php?page=pm_add_group&id=<?php echo $id; ?>&tab=group_fields"><?php _e('Group Fields', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
            ...
            <div class="pg-options-nav pg-core-options">
                <div class="pg-setting-title">Related Links</div>
                <ul>
                    <li><a target="_blank" href="admin.php?page=pm_profile_fields&gid=<?php echo esc_attr($id);?>"><?php _e('Group Registration Form Fields', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                     <?php if($group_type=='closed'):?>
                    <li><a target="_blank" href="admin.php?page=pm_requests_manager&pagenum=1&gid=<?php echo esc_attr($id);?>"><?php _e('Membership Requests', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                    <?php endif; ?>
                    <li><a target="_blank" href="admin.php?page=pm_user_manager&pagenum=1&gid=<?php echo esc_attr($id);?>"><?php _e('Group Members', 'profilegrid-user-profiles-groups-and-communities'); ?></a></li>
                     ...
                     <div class="uimrow">
                         ...
                         <div class="uiminput pm_radio_required">
                             <ul class="uimradio">
                                 ...
                                 <li>
                                     <input type="radio" name="group_options[group_type]" id="group_type" value="closed" onclick="pm_show_hide_group_type_options('show')" <?php if (!empty($group_options) && isset($group_options['group_type']) && $group_options['group_type'] == 'closed') {
                                     echo "checked";
                                 } ?>>
...
<input type="hidden" name="group_tab" value="display_name_pattern" />
              <?php endif; ?>
                 ...
                 <div id="membership" class="pg-group-tabs-panel">
                     ...
                     <?php esc_html_e('Membership Limit', 'profilegrid-user-profiles-groups-and-communities'); ?>
                         ...
                         <div class="uiminput">
                             <input name="is_group_limit" id="is_group_limit" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($row) && $row->is_group_limit == 1) {
                         echo "checked";
                     ...
                     <div class="childfieldsrow" id="grouplimit_html" style=" <?php if (!empty($row) && $row->is_group_limit == 1) {
                 echo 'display:block;';
             } else {
                 echo 'display:none;';
             } ?>">
    ...
    <?php esc_html_e('Max no. of Members', 'profilegrid-user-profiles-groups-and-communities'); ?>
                             ...
                             <div class="uiminput <?php if (!empty($row) && $row->is_group_limit == 1) {
        echo 'pm_required';
    } ?>">
    ...
    <?php esc_html_e('Limit Reached Message', 'profilegrid-user-profiles-groups-and-communities'); ?>
                             ...
                             <div class="uiminput">
    <?php if (isset($row)) $group_limit_message = $row->group_limit_message;
    else $group_limit_message = '';
...
<input type="hidden" name="group_tab" value="membership" />
             ...
             <?php if ($tab == 'management'): ?>                        
                 <div id="management" class="pg-group-tabs-panel">
                     <div class="uimrow" id="pm_group_admin_html">
                         ...
                         <div class="uiminput">
                             <input name="is_group_leader" id="is_group_leader" type="checkbox"  class="pm_toggle" value="1" <?php if (!empty($row) && $row->is_group_leader == 1) {
                             echo "checked";
    ...
    <?php endif; ?>
                     ...
                     <div class="childfieldsrow" id="groupleaderhtml" style=" <?php if (!empty($row) && $row->is_group_leader == 1) {
        echo 'display:block;';
    } else {
        echo 'display:none;';
    } ?>">
    ...
    <?php if (!class_exists('Profilegrid_Group_Multi_Admins')): ?>
                             <div class="uimrow">
                                 ...
                                 <div class="uiminput <?php if (!empty($row) && $row->is_group_leader == 1) {
        ...
        <?php foreach ($all_users as $user): ?>
                                             <option value="<?php echo esc_attr($user->ID); ?>" <?php if (!empty($group_leaders) && isset($group_leaders['primary']) && $group_leaders['primary'] == $user->ID) {
                echo 'selected';
...
<?php if ($tab == 'group_fields'): ?>                       
        ...
        <div class="pg-ui-info-notice pg-premium-extension-notice">
            <div class="pg-premium-extension-notice-wrap">
            <span class="pg-premium-extension-icon"> <img src="<?php echo esc_url($path . 'images/group-custom-fields.png'); ?>" class="pg-plugin-icon" alt=""></span>
            <div class="pg-premium-extension-text"><?php esc_html_e('You can unlock these options by upgrading to ProfileGrid Premium or Installation Custom Group Properties Extension.', 'profilegrid-user-profiles-groups-and-communities'); ?>
            <div class="pg-premium-extensionlink-wrap"><a href="admin.php?page=pm_extensions" target="_blank" class="pg-premium-extension-link">Learn More <span class="material-icons"> navigate_next </span></a></div>
            </div>
            </div>
...
<?php if ($tab == 'emails'): ?>                        
                 <div id="emails" class="pg-group-tabs-panel">
                     <div class="uimrow" id="notification">
                         ...
                         <div class="uiminput">
                             <input name="group_options[enable_notification]" id="enable_notification" type="checkbox"  class="pm_toggle" value="1" style="display:none;"  onClick="pm_show_hide(this,'notification_html')" <?php if (!empty($group_options) && isset($group_options['enable_notification']) && $group_options['enable_notification'] == 1) {
                                     echo "checked";
                     ...
                     <div class="childfieldsrow" id="notification_html" style=" <?php if (!empty($group_options) && isset($group_options['enable_notification']) && $group_options['enable_notification'] == 1) {
                                     echo 'display:block;';
                                 } elseif ($id == 0) {
                                     echo 'display:block;';
                                 } else {
    ...
    <?php esc_html_e('On Joining Group', 'profilegrid-user-profiles-groups-and-communities'); ?>
                             ...
                             <div class="uiminput <?php if ($id == 0 || (!empty($group_options) && isset($group_options['enable_notification']) && $group_options['enable_notification'] == 1)) {
        echo '';
    } ?>" >
                                 <select name="group_options[on_registration]" id="on_registration">
                                     ...
                                     foreach ($email_template as $tmpl) {
                                         ?>
                                         <option value="<?php echo esc_attr($tmpl->id); ?>" <?php if (!empty($group_options)) {
                         ...
                         <div class="uimrow pg-close-group-related-field" style="<?php if ($id == 0 || (!empty($group_options) && isset($group_options['group_type']) && $group_options['group_type'] == 'open')) {
                                 echo "display:none";
                             } ?>">
                             <div class="uimfield">
    <?php esc_html_e('On Request Denied', 'profilegrid-user-profiles-groups-and-communities'); ?>
                             </div>
                             <div class="uiminput <?php if (!empty($group_options) && isset($group_options['enable_notification']) && $group_options['enable_notification'] == 1 && $group_options['group_type'] == 'closed') {
        echo '';
    } ?>" >
    ...
    <?php esc_html_e(' On Publishing New Post', 'profilegrid-user-profiles-groups-and-communities'); ?>
        ...
        echo '';
                 ...
                 echo 'selected';
                     ...
                     <div class="childfieldsrow" id="admin_notification_html" style=" <?php if (!empty($group_options) && isset($group_options['enable_group_admin_notification']) && $group_options['enable_group_admin_notification'] == 1) {
                                 echo 'display:block;';
                             } elseif ($id == 0) {
                                 echo 'display:block;';
                             } else {
    ...
    <?php esc_html_e('Membership Request', 'profilegrid-user-profiles-groups-and-communities'); ?>
                             ...
                             <div class="uiminput <?php if (!empty($group_options) && isset($group_options['enable_group_admin_notification']) && $group_options['enable_group_admin_notification'] == 1 && $group_options['group_type'] == 'closed') {
        echo '';
    } ?>">
    ...
    ?>
                         ...
                         <div class="uimrow">
                             ...
                             <div class="uiminput <?php if ($id == 0 || (!empty($group_options) && isset($group_options['enable_group_admin_notification']) && $group_options['enable_group_admin_notification'] == 1)) {
                                 echo '';
                             } ?>">
    ...
    ?>
                         ...
                         <div class="uimrow pg-no-group-manager-related-field" style="<?php if ($id == 0 || (!empty($row) && $row->is_group_leader != 1)) {
        echo "display:none";
    } ?>">
                             <div class="uimfield">
    <?php esc_html_e('On Group Manager Removal', 'profilegrid-user-profiles-groups-and-communities'); ?>
                             </div>
                             <div class="uiminput <?php if (!empty($group_options) && isset($group_options['enable_group_admin_notification']) && $group_options['enable_group_admin_notification'] == 1) {
        echo '';
    } ?>">
             ...
             <div id="mailchimp" class="pg-group-tabs-panel">
                ...
                <div class="uimrow">
                 ...
                 <div class="uimrow"> 
                             <div class="pg-ui-info-notice pg-premium-extension-notice">
                                 <div class="pg-premium-extension-notice-wrap">
                                     <span class="pg-premium-extension-icon"> <img src="<?php echo esc_url($path . 'images/pg-mailchimp.png'); ?>" class="pg-plugin-icon" alt=""></span>
                                     <div class="pg-premium-extension-text"><?php esc_html_e('You can unlock these options by upgrading to ProfileGrid Premium or Installation MailChimp Integration Extension.', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                         <div class="pg-premium-extensionlink-wrap"><a href="admin.php?page=pm_extensions" target="_blank" class="pg-premium-extension-link">Learn More <span class="material-icons"> navigate_next </span></a></div>
                                     </div>
                                 </div>
...
<div class="uimrow">
     ...
     <div class="uimrow"> 
        <div class="pg-ui-info-notice pg-premium-extension-notice">
            <div class="pg-premium-extension-notice-wrap">
            <span class="pg-premium-extension-icon"> <img src="<?php echo esc_url($path . 'images/pg-woo-advanced-icon.png'); ?>" class="pg-plugin-icon" alt=""></span>
            <div class="pg-premium-extension-text"><?php esc_html_e('You can unlock these options by upgrading to ProfileGrid Premium or Installation WooCommerce Integration Extension.', 'profilegrid-user-profiles-groups-and-communities'); ?>
            <div class="pg-premium-extensionlink-wrap"><a href="admin.php?page=pm_extensions" target="_blank" class="pg-premium-extension-link">Learn More <span class="material-icons"> navigate_next </span></a></div>
            </div>
            </div>
...
<?php if ($tab == 'group_registration_form'): ?>                       
    ...
    <?php esc_html_e('None', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                 ...
                                 <li>
                                     <input type="radio" name="group_options[redirect]" id="redirect" value="page" <?php if (!empty($group_options) && isset($group_options['redirect']) && $group_options['redirect'] == 'page') {
        echo "checked";
    } ?> onClick="pm_show_hide(this,'redirect_page_html','redirect_url_html')">
    <?php esc_html_e('Page', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                 </li>
                                 <li>
                                     <input type="radio" name="group_options[redirect]" id="redirect" value="url" <?php if (!empty($group_options) && isset($group_options['redirect']) && $group_options['redirect'] == 'url') {
        echo "checked";
    ...
    <?php esc_html_e('URL', 'profilegrid-user-profiles-groups-and-communities'); ?>
                     ...
                     <div class="childfieldsrow" id="redirect_page_html" style=" <?php if (!empty($group_options) && isset($group_options['redirect']) && $group_options['redirect'] == 'page') {
        echo 'display:block;';
    } else {
        echo 'display:none;';
    } ?>">
    ...
    <?php wp_dropdown_pages($args); ?>
                     ...
                     <div class="childfieldsrow" id="redirect_url_html" style=" <?php if (!empty($group_options) && isset($group_options['redirect']) && $group_options['redirect'] == 'url') {
        echo 'display:block;';
    } else {
        echo 'display:none;';
    } ?>">
    ...
    <?php esc_html_e('Display a Message after Registration', 'profilegrid-user-profiles-groups-and-communities'); ?>
                         ...
                         <div class="uiminput">
                             <input name="show_success_message" id="show_success_message" type="checkbox"  class="pm_toggle" value="1" style="display:none;"  onClick="pm_show_hide(this,'success_message_html')" <?php if (!empty($row) && $row->show_success_message == 1) {
        echo "checked";
    } ?>/>
                     ...
                     <div class="childfieldsrow" id="success_message_html" style=" <?php if (!empty($row) && $row->show_success_message == 1) {
        echo 'display:block;';
    } else {
        echo 'display:none;';
    } ?>">
    ...
    <?php esc_html_e('Message Contents', 'profilegrid-user-profiles-groups-and-communities'); ?>
                             ...
                             <div class="uiminput">
    <?php if (isset($row)) $success_message = $row->success_message;
