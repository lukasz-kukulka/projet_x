		...
		if(isset($post['gids']) && !empty($post['gids']))
                {
                    foreach($post['gids'] as $gid)
                    {
                        ...
                        echo '<input type="hidden" name="selected[]" value="'.$row->id.'" />';
                            echo '<div class="pg-group-row-icon pg-box-col-2">';
                                ...
                                if (!empty($row) && $row->group_icon != 0) {
                                    ...
                                    ?>
                                    <img src="<?php echo $path .'partials/images/pg-icon.png'; ?>" />
                                    <?php
                                }
                            echo '</div>';
                            echo '<div class="pg-group-row-meta pg-box-col-10">';
                                echo '<div class="pg-group-card-title">'.$row->group_name.'</div>';
                                echo '<div class="pg-group-card-subtitle">'.$total_users.' '. esc_html__('members','profilegrid-user-profiles-groups-and-communities') .'</div>';
                            echo '</div>';
                        echo '</div>';
                    }
                }
