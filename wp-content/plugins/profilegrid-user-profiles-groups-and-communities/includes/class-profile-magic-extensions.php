...
class Profile_Magic_Extensions {
    ...
    public function pg_extension_status($ext)
    {
        ...
        {
           echo '<span class="pg-ext-installed">'. __('Installed','profilegrid-user-profiles-groups-and-communities').'</span>';
        }
        elseif($this->pg_check_extension_installed($ext['path']))
        {
            echo '<span class="pg-ext-not-installed">'. __('Inactive','profilegrid-user-profiles-groups-and-communities').'</span>';
        }
        else
        {
            
            echo '<span class="pg-ext-not-installed">'. __('Not Installed','profilegrid-user-profiles-groups-and-communities').'</span>';
        }
    }
