<?php if( ! defined( 'ABSPATH' ) ) exit;
	...
	<div class="soc-right">
	<?php if (get_theme_mod('social_media_contacts_address')) { ?><span><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo esc_html( get_theme_mod( 'social_media_contacts_address' ) ); ?></span><?php } ?>
	<?php if (get_theme_mod('social_media_contacts_phone')) { ?><span><i class="fa fa-volume-control-phone" aria-hidden="true"></i> <?php echo esc_html( get_theme_mod( 'social_media_contacts_phone' ) ); ?></span><?php } ?>
